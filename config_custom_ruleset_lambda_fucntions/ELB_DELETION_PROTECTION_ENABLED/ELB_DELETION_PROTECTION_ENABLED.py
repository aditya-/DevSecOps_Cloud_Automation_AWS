...
Description:
  Check whether an Elastic Load Balancer has deletion protection enabled.
...
Scenarios:
  Scenario: 1
     Given: deletion_protection.enabled in is set to False in 'LoadBalancerAttributes' in the configuration item
      Then: Return NON_COMPLIANT with annotation "This Elastic Load Balancer does not have deletion protection enabled."
  Scenario: 2
     Given: deletion_protection.enabled is set to True in 'LoadBalancerAttributes' in the configuration item
